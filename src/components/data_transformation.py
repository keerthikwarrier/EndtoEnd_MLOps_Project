...
from sklearn.pipeline import Pipeline #chains multiple preprocessing steps together so they run sequentially
from sklearn.preprocessing import OneHotEncoder,StandardScaler #StandardScaler scales numerical features so they have mean = 0 and standard deviation = 1.
